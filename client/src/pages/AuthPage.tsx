...
export default function AuthPage() {
  ...
  return <PageShell><section className="auth-page"><div className="container auth-grid">
    <div className="auth-copy"><span className="eyebrow"><ShieldCheck /> دخول آمن</span><h1>سجّل الدخول برقم الجوال</h1><p>يستخدم بلو ريهاب مصادقة Supabase OTP. لا تحفظ المنصة كلمة مرور، وتُنشأ الجلسة بعد التحقق من الرمز.</p><div className="auth-assurance"><ShieldCheck /><span><strong>حماية الجلسة</strong><small>مفتاح الخدمة السري يبقى في الخادم فقط، وتخضع البيانات لسياسات RLS.</small></span></div></div>
    <div className="auth-card">
      ...
      {step === "done" && <div className="auth-success"><CheckCircle2 /><h2>أنت مسجل الدخول</h2><p>يمكنك متابعة الإجراء المطلوب أو فتح لوحة حسابك.</p><a className="button" href={returnTo}>متابعة</a><button className="button button-secondary" type="button" onClick={signOut}>تسجيل الخروج</button></div>}
